...
public class RedactPII {
    ...
    public DictionaryValue execute(
        ...
        @Pkg(label = "Model", description = "Small Language Model to use for redaction. Qwen2.5 3B recommended.", default_value = "qwen2.5-3b", default_value_type = DataType.STRING)
        @NotEmpty
        String modelName,
